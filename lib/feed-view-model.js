...
const JUDGMENT_LABEL_PATTERN = /^(产业判断|产业观察|行业判断|行业观察|专家判断|核心判断|总体判断|判断)[:：]\s*(.+)$/u;
const SECTION_LABEL_PATTERN = /^(产业信号|市场影响|关注方向|机会与风险|产业建议|重点变化|进一步关注|行动建议|值得关注|专家建议)[:：]?\s*(.*)$/u;
