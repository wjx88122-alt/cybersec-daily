      ...
      <header className="sticky top-0 z-10 bg-[#111] border-b border-[#222]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center h-full">
            <Link href="/" className="px-4 h-full flex items-center text-sm font-semibold text-[#888] hover:text-white transition-colors border-b-2 border-transparent hover:border-[#e5ff00]/40">
              资讯
            </Link>
            <Link href="/digest" className="px-4 h-full flex items-center text-sm font-semibold text-white border-b-2 border-[#e5ff00]">
              简报
            </Link>
          </nav>
        </div>
